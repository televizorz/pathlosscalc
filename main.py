...
firstTab_d_2d_entry.insert(0, "d(2D)")
...
firstTab_h_bs_entry.insert(0, "h(BS)")
...
firstTab_h_ut_entry.insert(0, "h(UT)")
...
firstTab_f_c_entry.insert(0, "f(c)")
...
secondTab_d_2d_entry.insert(0, "d(2D)")
...
secondTab_h_bs_entry.insert(0, "h(BS)")
...
secondTab_h_ut_entry.insert(0, "h(UT)")
...
secondTab_f_c_entry.insert(0, "f(c)")
...
thirdTab_d_2d_entry.insert(0, "d(2D)")
...
thirdTab_h_bs_entry.insert(0, "h(BS)")
...
thirdTab_h_ut_entry.insert(0, "h(UT)")
...
thirdTab_f_c_entry.insert(0, "f(c)")
